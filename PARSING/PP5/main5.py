...
def get_data():
    ...
    with open(f"labirint_{cur_time}.csv", "w", encoding="utf8") as file:
    ...
    # for page in range(1, 2):
        ...
        for bi in books_items:
            ...
            try:
                ...
                book_title = "There are no books available"

            try:
                book_author = book_data[1].text.strip()
            except:
                book_author = "There is no author"
        ...
        print(f"We worked {page}/{pages_count}")
        time.sleep(1)
...
def main():
    ...
    print(f"Code done, time: {finish_time}")
